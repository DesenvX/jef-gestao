...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Colheitadera</td>
                                            <td>
                                                <button type="button" class="btn btn-warning btn-circle btn-sm" data-toggle="modal" data-target="#modalEditEquipment" data-vehicle="BM 135" data-tool="Colheitadera">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="text-center">
                                    <img src="../../img/equipamento.png" width="100" height="100" style="margin-bottom: 10px;">
                                </div>
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><b style="color: #566573;">Cadastrar Equipamento</b></h1>
                                </div>
                ...
                <div name="EditEquipment" class="modal fade" id="modalEditEquipment" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="text-center">
                                ...
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><b style="color: #566573;">Editar Equipamento</b></h1>
                                </div>
                                <form class="user" action="#" method="post">
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-3 mb-sm-0">
    ...
    <script>
        $('#modalEditEquipment').on('show.bs.modal', function(event) {
            ...
            var recipientvehicle = button.data('vehicle')
            var recipienttool = button.data('tool')
            var modal = $(this)
            modal.find('.modal-body #vehicle').val(recipientvehicle)
            modal.find('.modal-body #tool').val(recipienttool)
        })
    </script>
