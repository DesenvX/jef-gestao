                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><b style="color: #566573;">Cadastrar Categorias</b></h1>
                                    </div>
                                    <form class="user">
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" id="nameCategories" placeholder="Name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="descriptionCategories" placeholder="Descrição">
                                        </div>
