                                    ...
                                    <form class="user">
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" id="nameEmployees" placeholder="Name">
                                            </div>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control form-control-user" id="celullarEmployees" placeholder="Celular">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user" id="cpfEmployees" placeholder="CPF">
                                        </div>
